/*
 * Quote — full-bleed navy testimonial band. A green quote-left mark sits above
 * the white quote heading, with the attribution line below. Matches the
 * source "Independence allows us to stay accountable..." testimonial.
 */

export default function decorate(block) {
  const icon = document.createElement('span');
  icon.className = 'quote-mark';
  icon.setAttribute('aria-hidden', 'true');
  icon.innerHTML = `<svg viewBox="0 0 512 512" focusable="false">
